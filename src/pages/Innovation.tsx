        ...
        <div className="mx-auto grid max-w-[1400px] gap-12 px-6 lg:grid-cols-2 lg:px-10">
          ...
          <Reveal delay={0.1} className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-muted-foreground md:text-lg">
              From bioavailability work in Geneva to consumer panels in Singapore, every Vitala
              product is shaped by independent science before it ever reaches a shelf.
            </p>
          </Reveal>
        </div>
      </section>
