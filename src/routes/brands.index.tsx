...
function BrandsIndex() {
  return (
    <>
      <Seo
        title="Our Brands — Vitala Global"
        description="Discover Vitala Global's family of trusted consumer healthcare brands: NovaVit, Pureskin, Dentapro, Calmrest and KidsGlow."
      />
